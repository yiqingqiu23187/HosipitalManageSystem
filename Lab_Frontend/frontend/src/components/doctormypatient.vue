        ...
        <div  class="text item">
          <el-table :data="patients" style="width: 100%">
            ...
            <el-table-column label="操作">
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button size="mini" @click="patientid=scope.row.patientid;change()" >
                    修改他的信息</el-button>
                </template>
              </el-table-column>
          </el-table>
  ...
  export default {
    ...
    methods: {
      choose:function () {
        ...
        this.$router.replace({path:'/doctorrecord'})
      },
      change:function () {
        this.$store.commit('patientid', this.patientid);
        this.$router.replace({path:'/doctorchangepatientinformation'})
      },
